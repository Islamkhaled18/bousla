...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('admin.join-requests.edit', $join_request->id) }}"
                    title="تعديل طلب انضمام">تعديل طلب انضمام</a></li>
            @endcan
        </ul>
    </div>
    <div class="row">
            ...
            <div class="tile">
                <div class="tile-body">
                    <div class="container-fluid">
                        <form action="{{route('admin.join-requests.update', $join_request->id)}}" method="POST"
                            ...
                            <div class="tile-footer">
                                ...
                                <a href="{{ route('admin.join-requests.index') }}" class="btn btn-secondary">إلغاء</a>
                            </div>
                        </form>
                    </div>
                </div>
