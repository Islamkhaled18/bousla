    ...
    <main class="app sidebar-mini rtl">
        <div class="app-title">
            ...
            <ul class="app-breadcrumb breadcrumb side">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('admin.admins.index') }}" title="المشرفين" >المشرفين</a></li>
            </ul>
        </div>
        {{--  @can('admins.create')  --}}
            <div>
                <a class="btn btn-primary btn-sm" href="{{ route('admin.admins.create') }}" title="انشاء مشرف جديد">انشاء مشرف جديد</a>
            </div>
        {{--  @endcan  --}}
                                        ...
                                        <td>
                                            {{--  @can('admins.edit')  --}}
                                                <a class="btn btn-sm btn-dark"
                                                    href="{{ route('admin.admins.edit', $admin) }}" title="تعديل">تعديل</a>
                                            {{--  @endcan  --}}
                                            {{--  @can('admins.destroy')  --}}
