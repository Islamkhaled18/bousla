...
<main class="app sidebar-mini rtl">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            @can('settings')
            <li class="breadcrumb-item"><a href="{{ route('admin.settings.index') }}" title="الاعدادات">الاعدادات</a>
            </li>
            @endcan
        </ul>
    </div>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form enctype="multipart/form-data" method="post"
                        action="{{ route('admin.settings.update', 'test') }}">
                        @csrf
                        ...
                        <div class="col-md-12 border-right-2 border-right-blue-400">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label class="col-lg-2 col-form-label font-weight-semibold"> الواتس اب<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <input name="whatsapp" value="{{ $setting['whatsapp'] }}" required
